...
<template>
  <footer id="kontak" class="py-20 bg-gray-800 text-white">
    <div class="container mx-auto px-6 text-center">
      ...
      <a href="zulfameydita@students.amikom.ac.id" class="bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300 inline-block mb-12">Kirim Email</a>
      ...
      <p class="text-gray-500">&copy; {{ new Date().getFullYear() }}Zulfa  . Dibuat dengan </p>
    </div>
  </footer>
</template>
